...
from reachy_eleven_agent.config import config
from reachy_eleven_agent.prompts import get_session_voice, get_session_instructions
from reachy_eleven_agent.tools.core_tools import (
    ToolDependencies,
    get_tool_specs,
)
from reachy_eleven_agent.tools.background_tool_manager import (
    ToolCallRoutine,
    ToolNotification,
...
class OpenaiRealtimeHandler(AsyncStreamHandler):
    ...
    async def apply_personality(self, profile: str | None) -> str:
        ...
        try:
            ...
            from reachy_eleven_agent.config import config as _config
            from reachy_eleven_agent.config import set_custom_profile

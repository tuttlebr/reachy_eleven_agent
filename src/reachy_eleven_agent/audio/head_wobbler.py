...
from reachy_eleven_agent.audio.speech_tapper import HOP_MS, SwayRollRT
...
class HeadWobbler:
    ...
    def feed(self, delta_b64: str, start_delay_s: float = 0.0) -> None:
        """Thread-safe: push base64 encoded 24 kHz PCM audio into the consumer queue."""
    ...
    def working_loop(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                chunk_generation, sr, chunk, start_delay_s = queue_ref.get(timeout=hop_dt)
            except queue.Empty:
                continue

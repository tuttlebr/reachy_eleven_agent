...
from reachy_eleven_agent.config import LOCKED_PROFILE, config
from reachy_eleven_agent.openai_realtime import OpenaiRealtimeHandler
from reachy_eleven_agent.headless_personality_ui import mount_personality_routes
...
class LocalStream:
    ...
    def _persist_api_key(self, key: str) -> None:
        ...
        - Writes/updates ``<instance_path>/.env``:
          ...
          * Else, copies template from ``<instance_path>/.env.example`` when present,
            ...
            ``reachy_eleven_agent/.env.example``.
    ...
    def _init_settings_ui_if_needed(self) -> None:
        ...
        def _ready() -> JSONResponse:
            try:
                mod = sys.modules.get("reachy_eleven_agent.tools.core_tools")
